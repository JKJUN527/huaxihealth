...
@section('content')
    ...
    <div class="i_content">
        <div class="adr_wrap">
            <div class="adr">
                <span class="adr_link"><a href="/">首   页</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;<a href="/industry">产业服务</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;政策聚焦</span>
            </div>
        </div>
        <div class="c_area">
            @include('components.industryTab',['index'=>2])
            <div class="right_content">
                <div class="con_title">政策聚焦</div>
                <div class="con_box">
                    @forelse($data['data'] as $new)
                        <div class="ny_tdbk">
                            <div class="ny_dtimbk">
                                <div class="ny_dtim">
                                    <a href="/industry/policy/detail?nid={{$new->id}}">
                                        @if($new->picture != null)
                                            <?php
                                ...
                                <div class="ny_dtimrt">
                                    ...
                                    <div class="ny_dtimjj">
                                        ...
                                        <a href="/industry/policy/detail?nid={{$new->id}}">[详情]</a>
                                    </div>
                                </div>
                            </div>
                        </div>
