...
@section('sidebar')
    @include('components.adminAside', ['title' => 'industry', 'subtitle'=>'policy', 'username' => $data['username']])
@endsection
                    ...
                    <div class="mdl-card__menu">
                        ...
                        <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                            ...
                            <li class="mdl-menu__item">
                                <a href="/admin/industry/addIndustry?type=1">添加政策聚焦</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
@section('custom-script')
    <script type="text/javascript">
        ...
        $(".detail").click(function () {
            ...
            $.ajax({
                url: "/admin/industry/Detail?type=1&nid=" + nid,
                type: "get",
        ...
        $(".delete").click(function () {
            ...
            swal({
                ...
                $.ajax({
                    url: "/admin/industry/Del?type=1&id=" + element.attr('data-content'),
                    type: "get",
                    success: function (data) {
