...
@section('sidebar')
    @include('components.adminAside', ['title' => 'cooperation', 'subtitle'=>'out', 'username' => $data['username']])
@endsection
                    ...
                    <div class="mdl-card__menu">
                        ...
                        <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                            ...
                            <li class="mdl-menu__item">
                                <a href="/admin/cooperation/addCooperation?type=1">添加对外合作</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
@section('custom-script')
    <script type="text/javascript">
        ...
        $(".detail").click(function () {
            ...
            $.ajax({
                url: "/admin/cooperation/Detail?type=1&nid=" + nid,
                type: "get",
        ...
        $(".delete").click(function () {
            ...
            swal({
                ...
                $.ajax({
                    url: "/admin/cooperation/Del?type=1&id=" + element.attr('data-content'),
                    type: "get",
                    success: function (data) {
