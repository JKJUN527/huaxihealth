...
@section('sidebar')
    @include('components.adminAside', ['title' => 'technology', 'subtitle'=>'achievementsAdd', 'username' => $data['username']])
@endsection
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                    ...
                    <div class="mdl-card__menu">
                        ...
                        <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                            ...
                            <li class="mdl-menu__item">
                                <a href="/admin/technology/achievements">返回成果列表</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="body">
                    <form role="form" method="post" id="add-team-form">

                        <div class="input-group">
                            <div class="form-line">
                                <input type="text" id="title" name="title" class="form-control" placeholder="科研成果标题">
                            </div>
...
//            content.val(content.val() + "[图片" + i + "]");
        ...
        $("#submit-news").click(function (event) {
            ...
            $.ajax({
                url: "/admin/technology/addAchievements",
                type: "post",
                dataType: 'text',
                cache: false,
                contentType: false,
                ...
                success: function (data) {
                    ...
                    if (result.status === 200) {
                        setTimeout(function () {
                            self.location = '/admin/technology/achievements';
                        }, 1200);
                    }
                },
