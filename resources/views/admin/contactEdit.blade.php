...
@section('sidebar')
    @include('components.adminAside', ['title' => 'contact', 'subtitle'=>'form', 'username' => $data['username']])
@endsection

@section('content')
    <div style="display: none;" id="old_info">
        {!! $data['webinfo']->contact_content !!}
    </div>
...
@section('custom-script')
    ...
    <script type="text/javascript">
        ...
        $(window).load(function(){
            var old_code = $('#old_info').html();
            var new_code = $('.w-e-text');
            new_code.html(old_code);
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result.status === 200) {
                        setTimeout(function () {
                            self.location = '/admin/contact/form';
                        }, 1200);
                    }
                },
