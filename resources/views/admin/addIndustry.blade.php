...
@section('sidebar')
    @include('components.adminAside', ['title' => 'industry', 'subtitle'=>'industry', 'username' => $data['username']])
@endsection
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                    ...
                    <div class="mdl-card__menu">
                        ...
                        <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                            ...
                            <li class="mdl-menu__item">
                                <a href="/admin/industry">返回产业动态列表</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="body">
                    <form role="form" method="post" id="add-industry-form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control show-tick selectpicker"
                                ...
                                <option value="0" @if(isset($data['type']) && $data['type'] == 0) selected @endif>产业动态</option>
                                <option value="1" @if(isset($data['type']) && $data['type'] == 1) selected @endif>政策聚焦</option>
                                <option value="2" @if(isset($data['type']) && $data['type'] == 2) selected @endif>孵化培育</option>
                                <option value="3" @if(isset($data['type']) && $data['type'] == 3) selected @endif>投资与基金</option>
                            </select>
