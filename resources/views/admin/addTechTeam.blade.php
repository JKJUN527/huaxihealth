...
@section('sidebar')
    @include('components.adminAside', ['title' => 'technology', 'subtitle'=>'teamAdd', 'username' => $data['username']])
@endsection
                    ...
                    <div class="mdl-card__menu">
                        ...
                        <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                            ...
                            <li class="mdl-menu__item">
                                <a href="/admin/technology/team">返回团队列表</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="body">
                    <form role="form" method="post" id="add-team-form">
                        ...
                        <div class="input-group">
                            <div class="form-line">
                                <input type="text" id="title" name="title" class="form-control" placeholder="团队名称">
                            </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (result.status === 200) {
                        setTimeout(function () {
                            self.location = '/admin/technology/team';
                        }, 1200);
                    }
                },
