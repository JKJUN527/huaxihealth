                    ...
                    <div class="mdl-card__menu">
                        ...
                        <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                            ...
                            <li class="mdl-menu__item">
                                <a href="/admin/industry/addIndustry?type=0">添加产业动态</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <table class="table table-striped" id="cu-admin-table">
                        ...
                        @forelse($data['industry'] as $industry)
                            <tr>
                                ...
                                <td>{{mb_substr($industry->content, 0, 60,'utf-8')}}...</td>
                                <td>{{$industry->created_at}}</td>
                                <td>
                                    <i class="material-icons detail" data-content="{{$industry->id}}"
                                       data-toggle='modal' data-target='#detailNewsModal'>visibility</i>
                                    <i class="material-icons delete" data-content="{{$industry->id}}"
                                       style="margin-left: 16px;">delete</i>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5">暂无产业动态发布</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
                    <nav>
                        {!! $data['industry']->render() !!}
                    </nav>
                </div>
            </div>
        </div>
...
@section('custom-script')
    <script type="text/javascript">
        ...
        $(".detail").click(function () {
            ...
            $.ajax({
                url: "/admin/industry/Detail?type=0&nid=" + nid,
                type: "get",
        ...
        $(".delete").click(function () {
            ...
            swal({
                ...
                $.ajax({
                    url: "/admin/industry/Del?type=0&id=" + element.attr('data-content'),
                    type: "get",
                    success: function (data) {
