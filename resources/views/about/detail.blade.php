...
@section('title', '大事记|成都华西精准医学产业技术研究院')
...
@section('content')
    ...
    <div class="i_content">
        <div class="adr_wrap">
            <div class="adr">
                <span class="adr_link"><a href="/">首   页</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;<a href="/about">关于我们</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;大事记</span>
            </div>
        </div>
        <div class="c_area">
            ...
            <div class="right_content">
                ...
                <div class="con_box">
                    <div class="ny_tdbk">
                        ...
                        <div class="ny_jlxqxt">时间：<font>{{$data['detail']->created_at}}</font>&nbsp;&nbsp;&nbsp;</div>
                        <div class="ny_jlxqjj">
                            <br>
                            {!! $data['detail']->content !!}
                        </div>
