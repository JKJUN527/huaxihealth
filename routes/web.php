...
Route::get('admin/addNotes', ['uses' => 'Admin\EditnewsController@addNotesView']);//新增或修改公告信息
Route::post('admin/news/add', ['uses' => 'Admin\EditnewsController@addNews']);//新增或修改新闻信息
Route::post('admin/notes/addNew', ['uses' => 'Admin\EditnewsController@addNotesNew']);//新增或修改新闻信息
